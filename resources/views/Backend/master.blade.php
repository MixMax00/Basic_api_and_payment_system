...
<head>
    ...
    <!-- Custom Stylesheet -->
	<link href="{{ asset('Backend/Bs') }}/bootstrap-select.min.css" rel="stylesheet">
...
<body>
 ...
 -->
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('Backend/Jq') }}/global.min.js"></script>
	<script src="{{ asset('Backend/js') }}/bootstrap-select.min.js"></script>
    <script src="{{ asset('Backend/Js') }}/custom.min.js"></script>
	<script src="{{ asset('Backend/plugin') }}/deznav-init.js"></script>
    ...
    <!-- Jquery Validation -->
    <script src="{{ asset('Backend/plugin') }}/jquery.validate.min.js"></script>
    <!-- Form validate init -->
    <script src="{{ asset('Backend/plugin') }}/jquery.validate-init.js"></script>
